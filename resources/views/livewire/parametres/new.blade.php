          ...
          <div class="text-center">
            ...
            <div class="d-flex justify-content-center">
              <div class="w-100 d-flex justify-content-center">
                ...
                <input class="form-control mx-2 @error('montant') border-danger @enderror" type="text"
                  placeholder="Montant" type="number" wire:keydown.enter="{{$submitFunction}}">
                @error('montant') <span class="text-danger fs-3"> {{ $message }} </span> @enderror
                @endif
              </div>
