...
class Adhesions extends Component
{
    ...
    public function insertToPmb()
    {
        ...
        $req->execute(array(
            ...
            'empr_pays' =>  isset($this->newAdhesion['pays'])? $this->newAdhesion['pays'] : NULL,
            'empr_year' => isset($this->newAdhesion['dateNaissance']) ? $this->newAdhesion['dateNaissance'] : NULL,
            'empr_ville' => isset($this->newAdhesion['ville']) ?  $this->newAdhesion['ville'] : NULL,
            'empr_prof' => isset($this->newAdhesion['profession']) ? $this->newAdhesion['profession'] : NULL,
            'empr_mail' => isset($this->newAdhesion['email']) ? $this->newAdhesion['email'] : NULL,
            'empr_tel1' => isset($this->newAdhesion['telephone1']) ? $this->newAdhesion['telephone1'] : NULL,
            'empr_adr1' => isset($this->newAdhesion['adresse']) ?  $this->newAdhesion['adresse'] : NULL,
