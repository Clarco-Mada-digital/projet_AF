...
class Adhesions extends Component
{
    ...
    public function insertToPmb()
    {
        ...
        $req->execute(array(
            ...
            'empr_pays' =>  $this->newAdhesion['pays'] ? $this->newAdhesion['pays'] : null,
            'empr_year' => $this->newAdhesion['dateNaissance'] ? $this->newAdhesion['dateNaissance'] : null,
            'empr_ville' => $this->newAdhesion['ville'] ?  $this->newAdhesion['ville'] : null,
            'empr_prof' => $this->newAdhesion['profession'] ? $this->newAdhesion['profession'] : null,
            'empr_mail' => $this->newAdhesion['email'] ? $this->newAdhesion['email'] : null,
            'empr_tel1' => $this->newAdhesion['telephone1'] ? $this->newAdhesion['telephone1'] : null,
            'empr_adr1' => $this->newAdhesion['adresse'] ?  $this->newAdhesion['adresse'] : null,
